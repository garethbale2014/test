...
public class StandesamtComposite extends EditorComposite {
	...
	public StandesamtComposite(Composite composite, FormToolkit toolkit, Long projectId) {
		super(projectId);
		...
		grpPersonAngaben.setText("Standesamt Information");
		...
		lblKrankenhaus.setText("Standesamt");
		...
		lblWebSiteLink.setText("www.standesamtwebsite.com");
