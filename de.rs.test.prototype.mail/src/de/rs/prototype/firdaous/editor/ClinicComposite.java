...
public class ClinicComposite extends EditorComposite {
	...
	public ClinicComposite(Composite composite, FormToolkit toolkit, Long projectId) {
		super(projectId);
		...
		grpPersonAngaben.setText("Krankenhaus Information");
		...
		lblWebSiteLink.setText("www.willi.com");
